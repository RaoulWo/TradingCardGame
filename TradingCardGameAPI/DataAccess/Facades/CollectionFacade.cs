...
public class CollectionFacade : ICollectionFacade
{
    ...
    {
        string sqlStatement = "INSERT INTO collection (Id, fk_player_id, fk_card_id) VALUES (@Id, @FkPlayerId, @FkCardId)";
        int rowsAffected = 0;
    ...
    {
        string sqlStatement = "UPDATE collection SET fk_player_id = @FkPlayerId, fk_card_id = @FkCardId WHERE Id = @Id";
        int rowsAffected = 0;
